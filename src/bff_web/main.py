...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF-Web AlpesOnline"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-orden", "alpesonline-bff", "public/default/eventos-orden", eventos=eventos))
    tasks.append(task1)
