...
from alpesonline.modulos.ordenes.dominio.entidades import Orden, Aeropuerto
from alpesonline.modulos.ordenes.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
